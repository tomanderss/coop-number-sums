...
export default {
  ...
  team: {
    toggleLabel: 'Team-vs-Team (2 gegen 2)',
  ...
  race: {
    ...
    youWon: 'Du warst fehlerfrei zuerst fertig! ({myPct}% vs. {oppPct}%)',
    youLost: 'Dein Gegner war zuerst fehlerfrei fertig. ({myPct}% vs. {oppPct}%)',
  },
  settings: {
    title: 'Einstellungen',
