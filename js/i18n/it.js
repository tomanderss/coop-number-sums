...
export default {
  ...
  team: {
    toggleLabel: 'Squadra contro squadra (2 contro 2)',
  ...
  race: {
    ...
    youWon: 'Hai finito primo, senza errori! ({myPct}% vs. {oppPct}%)',
    youLost: 'Il tuo avversario ha finito primo, senza errori. ({myPct}% vs. {oppPct}%)',
  },
  settings: {
    title: 'Impostazioni',
    appearance: 'Aspetto',
