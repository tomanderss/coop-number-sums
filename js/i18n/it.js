...
export default {
  ...
  shop: {
    catHint: { palette: 'Ricolora le gabbie del tabellone — la distinguibilità dei colori è sempre garantita.', theme: 'Mondi di colore completi per tutta l\'app — dal nero OLED al sakura.' , sfx: 'Nuovi mondi sonori per tutti i suoni di gioco — tocca ▶ per ascoltare.'},
    free: { palette: 'Classico', theme: 'Standard (chiaro/scuro)' , sfx: 'Standard'},
    it: { zen: 'Giardino zen', arcade: 'Arcade 8 bit', kristall: 'Campane di cristallo', kosmos: 'Cosmo', synthwave: 'Synthwave', kaffee: 'Caffetteria', oled: 'Notte OLED', tiefsee: 'Abissi', wald: 'Bosco notturno', sakura: 'Sakura', nebula: 'Nebulosa', sunset: 'Tramonto', cyberpunk: 'Cyberpunk', pastell: 'Sogno pastello', vintage: 'Vintage', daemmerung: 'Crepuscolo', neon: 'Bagliore neon', arktis: 'Artico', spiegel: 'Mondo specchio', cyber: 'Cyber-griglia', karneval: 'Carnevale' },
