...
export default {
  ...
  shop: {
    catHint: { palette: 'Ricolora le gabbie del tabellone — la distinguibilità dei colori è sempre garantita.', theme: 'Mondi di colore completi per tutta l\'app — dal nero OLED al sakura.' },
    free: { palette: 'Classico', theme: 'Standard (chiaro/scuro)' },
    it: { kaffee: 'Caffetteria', oled: 'Notte OLED', tiefsee: 'Abissi', wald: 'Bosco notturno', sakura: 'Sakura', nebula: 'Nebulosa', sunset: 'Tramonto', cyberpunk: 'Cyberpunk', pastell: 'Sogno pastello', vintage: 'Vintage', daemmerung: 'Crepuscolo', neon: 'Bagliore neon', arktis: 'Artico', spiegel: 'Mondo specchio', cyber: 'Cyber-griglia', karneval: 'Carnevale' },
