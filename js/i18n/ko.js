...
export default {
  ...
  aiduel: { opponent: '상대', oppPreset: '기본', oppClone: '내 클론', cloneLearning: '학습 중 ({n}/{need})', title: 'AI와 대결', hint: '당신의 속도에 맞춘 상대 — 오프라인에서도', opponentName: 'AI ({level})', strength: '강도', start: '대결 시작', expected: '상대 예상 기록: {time}', calibrated: '(당신의 평균 기록 기준)', default: '(기본값)', level: { easy: '쉬움', medium: '보통', hard: '어려움', brutal: '극악' } },
