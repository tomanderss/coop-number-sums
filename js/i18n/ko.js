...
export default {
  ...
  shop: {
    catHint: { palette: '보드 케이지 색을 바꿔보세요 — 색 구분은 항상 유지됩니다.', theme: '앱 전체의 색상 세계를 통째로 바꾸세요 — OLED 블랙부터 벚꽃까지.' },
    free: { palette: '클래식', theme: '기본 (라이트/다크)' },
    it: { kaffee: '커피하우스', oled: 'OLED 나이트', tiefsee: '심해', wald: '밤의 숲', sakura: '사쿠라', nebula: '성운', sunset: '노을', cyberpunk: '사이버펑크', pastell: '파스텔 드림', vintage: '빈티지', daemmerung: '황혼', neon: '네온 글로우', arktis: '북극', spiegel: '거울 세계', cyber: '사이버 그리드', karneval: '카니발' },
