...
export default {
  ...
  saves: { title: '저장된 게임', openN: '모든 저장 ({n})', intro: '게임마다 따로 저장됩니다. 새로 시작해도 이전 기록은 남습니다. 최대 {max}개까지 보관됩니다.', running: '진행 중', delete: '삭제', deleteTitle: '저장을 삭제할까요?', deleteMsg: '이 저장은 완전히 삭제됩니다.', deleted: '저장을 삭제했습니다', empty: '저장된 게임이 아직 없습니다.', justNow: '방금', minsAgo: '{n}분 전', hoursAgo: '{n}시간 전', yesterday: '어제', daysAgo: '{n}일 전' },

  aiduel: { opponent: '상대', oppPreset: '기본', oppClone: '내 클론', modePreset: '기본 AI', modeIndividual: '개인 AI', clone: '클론', noClones: '아직 사용할 수 있는 클론이 없습니다. 클론에는 분석된 솔로 게임 {need}판이 필요합니다(나와 친구 모두).', learningCount: '{n}개의 클론이 학습 중', learningTitle: '학습 중인 클론', learningIntro: '이 클론들은 아직 준비되지 않았습니다. 분석된 솔로 게임 {need}판부터 대결할 수 있습니다.', oppCloneName: '내 클론', oppFriend: '친구의 클론', friendClones: '친구 클론', clonesLoading: '클론 불러오는 중 …', cloneLearning: '학습 중 ({n}/{need})', title: 'AI와 대결', hint: '당신의 속도에 맞춘 상대 — 오프라인에서도', opponentName: 'AI ({level})', strength: '강도', start: '대결 시작', expected: '상대 예상 기록: {time}', calibrated: '(당신의 평균 기록 기준)', default: '(기본값)', level: { easy: '쉬움', medium: '보통', hard: '어려움', brutal: '극악' } },
  mismatch: { title: '게임 데이터가 다릅니다', sub: '코인 잔액이 이 기기와 클라우드에서 다릅니다. 게임 진행(승리, 업적, 구매)은 자동으로 병합됩니다. 적용할 잔액만 선택하세요.', subGame: '이 기기와 클라우드에 각각 다른 미완료 게임이 있습니다 — 오프라인으로 계속 플레이한 것 같습니다. 나머지 모든 것(진행, 업적, 설정)은 자동으로 병합됩니다. 어떤 진행 중인 게임을 적용할지만 선택하세요.', subBoth: '코인 잔액이 다르고, 이 기기와 클라우드에 각각 다른 미완료 게임이 있습니다. 나머지 진행은 자동으로 병합됩니다 — 잔액과 진행 중인 게임에 어느 쪽을 적용할지 선택하세요.', local: '이 기기', cloud: '클라우드', keepLocal: '이 기기 유지', keepCloud: '클라우드 유지', note: '다른 상태는 백업으로 저장되며 삭제되지 않습니다.' },
  ...
  team: {
    ...
    weWon: '우리 팀이 승리했습니다!',
    weLost: '상대 팀이 먼저 끝냈습니다.',
    weWonByOpponentLives: '상대 팀이 모든 생명을 잃었습니다 — 자동으로 승리합니다!',
    weLostByLives: '우리 팀이 모든 생명을 잃었습니다 — 매치가 종료되었습니다.',
  },
  chat: {
    typing: '{name} 님이 입력 중…',
    title: '채팅',
  ...
  race: {
    ...
    youWonClean: '실수 없이 먼저 완료했습니다!',
    youWonMistakes: '먼저 완료했습니다!',
    youLostClean: '{name}님이 더 빠르게 실수 없이 완료했습니다 — 당신이 더 느려서 대결이 종료되었습니다.',
    youLostMistakes: '{name}님이 더 빨랐습니다 — 당신이 더 느려서 대결이 종료되었습니다.',
    youWonByOpponentLives: '{name}님이 모든 생명을 잃었습니다 — 자동으로 승리합니다!',
    youLostByLives: '당신은 모든 생명을 잃었습니다 — 대결이 종료되었습니다.',
    rematch: '다시 플레이',
  },
  settings: {
    title: '설정',
  ...
  friends: {
    ...
    mode: { solo: '솔로', coop: '협동', race: '1대1', team: '팀', endless: '엔드리스', endlessCoop: '협동 엔드리스' },
  ...
  notice: { gift: '{from} 님이 "{item}" 을(를) 선물했어요!', revoke: '{from} 님이 "{item}" 을(를) 회수했어요.', currencyPlus: '{from} 님이 {n} 코인을 선물했어요!', currencyMinus: '{from} 님이 잔액을 {n} 코인 줄였어요.', currencySelfPlus: '자신에게 {n} 코인을 지급했습니다.', currencySelfMinus: '잔액을 {n} 코인 줄였습니다.', giftSelf: '「{item}」을(를) 자신에게 지급했습니다.', revokeSelf: '「{item}」을(를) 자신에게서 회수했습니다.' },
  shop: {
  ...
  tutor: {
    ...
    next: '다음',
    apply: '이해했어요 – 실행',
    lookAt: '{unit}을(를) 보세요: 여기서 동그라미 친 숫자의 합은 정확히 {target}이어야 합니다.',
    statusKept: '이미 표시된 것: {kept} = {keptSum}. 목표까지 정확히 {rem}이 남았습니다.',
    statusNone: '아직 아무것도 표시되지 않았습니다 – {rem} 전부가 남아 있습니다.',
    tooLarge: '강조된 {val}을(를) 보세요: 그것 하나만으로도 남은 {rem}보다 큽니다. 표시하면 합이 넘칩니다.',
    sumReached: '목표 합이 이미 정확히 달성되었습니다. 더 표시하면 초과합니다 – 남은 빈 칸은 포함될 수 없습니다.',
    allNeeded: '남은 숫자 {vals}의 합이 부족한 {rem}과 정확히 같습니다. 하나라도 빼면 목표에 도달할 수 없습니다 – 전부 필요합니다.',
    combos: '남은 숫자({vals}) 중 합이 정확히 {rem}이 되는 조합은? 세어 보면 이것뿐입니다: {combos}.',
    moreCombos: '(+{n}개 더)',
    inAllCombos: '조합을 비교해 보세요: 모든 조합에 강조된 {val}이(가) 들어 있습니다. 이것 없이는 남은 합을 만들 수 없습니다.',
    inNoCombo: '조합을 비교해 보세요: 강조된 {val}이(가) 들어간 조합은 하나도 없습니다. 포함될 수 없습니다.',
    overlapOther: '동시에 {unit2}도 봐야 합니다: 거기에는 정확히 {remB}이 남았습니다.',
    overlapShared: '이 칸들({vals})은 두 영역 모두에 속합니다. 두 남은 합을 맞춰 보면 합계는 {sums}만 가능합니다.',
    concludeKeep: '결론은 필연입니다: {val}은(는) 확실히 포함됩니다 – 동그라미 치세요.',
    concludeRemove: '결론은 필연입니다: {val}은(는) 확실히 포함되지 않습니다 – 지우세요.',
    hard: '이 국면은 여러 영역에 걸친 긴 연쇄가 필요합니다 – 강조된 영역에 다음 확실한 수가 있습니다.',
  },
  achievements: {
    title: '업적',
