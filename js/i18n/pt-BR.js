...
export default {
  ...
  shop: {
    catHint: { palette: 'Recolora as gaiolas do tabuleiro — as cores continuam sempre distinguíveis.', theme: 'Mundos de cores completos para o app inteiro — do preto OLED ao sakura.' },
    free: { palette: 'Clássico', theme: 'Padrão (claro/escuro)' },
    it: { kaffee: 'Cafeteria', oled: 'Noite OLED', tiefsee: 'Mar profundo', wald: 'Floresta noturna', sakura: 'Sakura', nebula: 'Nebulosa', sunset: 'Pôr do sol', cyberpunk: 'Cyberpunk', pastell: 'Sonho pastel', vintage: 'Vintage', daemmerung: 'Crepúsculo', neon: 'Brilho neon', arktis: 'Ártico', spiegel: 'Mundo espelho', cyber: 'Cibergrade', karneval: 'Carnaval' },
