...
export default {
  ...
  coop: {
    ...
    yourCode: 'Seu código',
    inviteFriends: "Convidar amigos", invite: "Convidar", invited: "Convidado", inviteSent: "{name} convidado", inviteDeclined: "{name} recusou", inviteAccepted: "{name} entrou", inviteTitle: "Convite para a sala", inviteBody: "{name} convida você para uma sala {mode}.", inviteAccept: "Entrar", inviteDecline: "Recusar", modeCoop: "Cooperativo", modeRace: "Duelo (1v1)", modeTeam: "Equipe (2v2)",
