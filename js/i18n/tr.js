...
export default {
  ...
  shop: {
    catHint: { palette: 'Tahtandaki kafesleri yeniden renklendir — renk ayırt edilebilirliği her zaman korunur.', theme: 'Tüm uygulama için eksiksiz renk dünyaları — OLED siyahından sakuraya.' , sfx: 'Tüm oyun sesleri için yeni ses dünyaları — dinlemek için ▶ dokun.', font: 'Tahtadaki sayılar için yeni yazı stilleri ve efektler.', frame: 'Tahtanın çevresine dekoratif çerçeveler — ahşaptan dönen ışıklı galaksi halkasına.', badge: 'Adının yanında bir rozet — coop\'ta, arkadaş listesinde ve lider tablosunda görünür.', skinpreset: 'Seçilmiş skin tasarımları — herkes satın alıp uygulayabilir. Özel dinamik skin ayrıca serbest skin düzenleyicisini açar.' },
    free: { palette: 'Klasik', theme: 'Standart (açık/koyu)' , sfx: 'Standart', font: 'Klasik', frame: 'Çerçevesiz', badge: 'Rozetsiz'},
