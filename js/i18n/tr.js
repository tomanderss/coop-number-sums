...
export default {
  ...
  shop: {
    catHint: { palette: 'Tahtandaki kafesleri yeniden renklendir — renk ayırt edilebilirliği her zaman korunur.', theme: 'Tüm uygulama için eksiksiz renk dünyaları — OLED siyahından sakuraya.' , sfx: 'Tüm oyun sesleri için yeni ses dünyaları — dinlemek için ▶ dokun.', font: 'Tahtadaki sayılar için yeni yazı stilleri ve efektler.', frame: 'Tahtanın çevresine dekoratif çerçeveler — ahşaptan dönen ışıklı galaksi halkasına.'},
    free: { palette: 'Klasik', theme: 'Standart (açık/koyu)' , sfx: 'Standart', font: 'Klasik', frame: 'Çerçevesiz'},
    it: { holz: 'Ahşap çerçeve', goldbarock: 'Altın barok', eis: 'Buz kristali', neonpuls: 'Neon nabız', feuer: 'Ateş halkası', regenbogen: 'Dönen gökkuşağı', galaxie: 'Galaksi halkası', mono: 'Retro mono', serif: 'Zarif serif', hand: 'El yazısı', graviert: 'Taşa kazınmış', neonfont: 'Neon yazı', umriss: 'Kontur', gold: 'Altın kabartma', zen: 'Zen bahçesi', arcade: '8-bit atari', kristall: 'Kristal çanlar', kosmos: 'Kozmos', synthwave: 'Synthwave', kaffee: 'Kahvehane', oled: 'OLED Gecesi', tiefsee: 'Derin deniz', wald: 'Gece ormanı', sakura: 'Sakura', nebula: 'Bulutsu', sunset: 'Gün batımı', cyberpunk: 'Siberpunk', pastell: 'Pastel rüya', vintage: 'Vintage', daemmerung: 'Alacakaranlık', neon: 'Neon ışıltı', arktis: 'Arktik', spiegel: 'Ayna dünyası', cyber: 'Siber ızgara', karneval: 'Karnaval' },
