...
export default {
  ...
  saves: { title: 'Kayitli oyunlar', openN: 'Tum kayitlar ({n})', intro: 'Her oyun ayri kaydedilir; istedigin zaman yenisine basla, eskisi durur. {max} kayit icin yer var.', running: 'devam ediyor', delete: 'Sil', deleteTitle: 'Kayit silinsin mi?', deleteMsg: 'Bu kayit kalici olarak silinecek.', deleted: 'Kayit silindi', empty: 'Henuz kayitli oyun yok.', justNow: 'az once', minsAgo: '{n} dk once', hoursAgo: '{n} sa once', yesterday: 'dun', daysAgo: '{n} gun once' },

  aiduel: { opponent: 'Rakip', oppPreset: 'Varsayılan', oppClone: 'Klonum', modePreset: 'Standart YZ', modeIndividual: 'Kisisel YZ', clone: 'Klon', noClones: 'Henuz hazir bir klon yok. Bir klon icin {need} degerlendirilmis tek kisilik oyun gerekir; hem senin hem arkadaslarin icin.', learningCount: '{n} klon hala ogreniyor', learningTitle: 'Egitimdeki klonlar', learningIntro: 'Bu klonlar henuz hazir degil. {need} degerlendirilmis tek kisilik oyundan sonra duelloya cikabilirler.', oppCloneName: 'Senin klonun', oppFriend: 'Arkadas klonu', friendClones: 'Arkadas klonlari', clonesLoading: 'Klonlar yukleniyor …', cloneLearning: 'hâlâ öğreniyor ({n}/{need})', title: 'Yapay zekâya karşı düello', hint: 'Kendi tempona göre bir rakip — çevrimdışı da çalışır', opponentName: 'YZ ({level})', strength: 'Güç', start: 'Düelloyu başlat', expected: 'Beklenen rakip süresi: {time}', calibrated: '(ortalama sürelerine göre)', default: '(varsayılan değer)', level: { easy: 'Kolay', medium: 'Orta', hard: 'Zor', brutal: 'Acımasız' } },
  ...
  team: {
    ...
    weWon: 'Takımınız kazandı!',
    weLost: 'Diğer takım önce bitirdi.',
    weWonByOpponentLives: 'Takım {oppTeam} tüm canlarını kaybetti — otomatik olarak kazandınız!',
    weLostByLives: 'Takımınız (Takım {myTeam}) tüm canlarını kaybetti — maç sizin için bitti.',
  },
  chat: {
    typing: '{name} yazıyor …',
    title: 'Sohbet',
  ...
  race: {
    ...
    youWonClean: 'Hatasız olarak önce bitirdin!',
    youWonMistakes: 'Önce bitirdin!',
    youLostClean: '{name} daha hızlıydı ve hatasız bitirdi — düello, sen daha yavaş olduğun için bitti.',
    youLostMistakes: '{name} daha hızlıydı — düello, sen daha yavaş olduğun için bitti.',
    youWonByOpponentLives: '{name} tüm canlarını kaybetti — otomatik olarak kazandın!',
    youLostByLives: 'Tüm canlarını kaybettin — düello senin için bitti.',
    rematch: 'Tekrar oyna',
  },
  settings: {
    title: 'Ayarlar',
  ...
  notice: { gift: '{from} sana "{item}" hediye etti!', revoke: '{from} senden "{item}" aldı.', currencyPlus: '{from} sana {n} jeton hediye etti!', currencyMinus: '{from} bakiyeni {n} jeton azalttı.', currencySelfPlus: 'Kendine {n} jeton tanımladın.', currencySelfMinus: 'Bakiyeni {n} jeton azalttın.', giftSelf: '"{item}" ögesini kendine tanımladın.', revokeSelf: '"{item}" ögesini kendinden aldın.' },
  shop: {
  ...
  tutor: {
    title: 'İpucu eğitmeni',
    next: 'İleri',
    apply: 'Anladım – uygula',
    lookAt: '{unit} bölgesine bak: buradaki daire içine alınan sayıların toplamı tam olarak {target} olmalı.',
    statusKept: 'Burada zaten işaretli: {kept} = {keptSum}. Hedefe tam {rem} kaldı.',
    statusNone: 'Burada henüz hiçbir şey işaretli değil – {rem} miktarının tamamı eksik.',
    tooLarge: 'Vurgulanan {val} sayısına bak: tek başına bile eksik olan {rem} değerinden BÜYÜK. Onu işaretlersen toplam aşılır.',
    sumReached: 'Hedef toplam zaten TAM olarak tutturuldu. Fazladan her sayı çok olur – kalan açık hücreler dahil olamaz.',
    allNeeded: 'Açık sayılar {vals} tam olarak eksik {rem} kadar ediyor. Birini bile çıkarırsan hedefe ulaşılamaz – hepsi gerekli.',
    combos: 'Açık sayılardan ({vals}) hangileri tam {rem} edebilir? Olasılıkları say – sadece şunlar var: {combos}.',
    moreCombos: '(+{n} tane daha)',
    inAllCombos: 'Olasılıkları karşılaştır: HER BİRİ vurgulanan {val} sayısını içeriyor. Onsuz kalan toplam tutturulamaz.',
    inNoCombo: 'Olasılıkları karşılaştır: HİÇBİRİ vurgulanan {val} sayısını içermiyor. Dahil olması imkânsız.',
    overlapOther: 'Aynı anda {unit2} de geçerli: orada tam {remB} eksik.',
    overlapShared: 'Bu hücreler ({vals}) HER İKİ bölgede de yer alıyor. İki kalan toplamı çakıştırınca birlikte sadece {sums} edebilirler.',
    concludeKeep: 'Sonuç zorunlu: {val} kesinlikle dahil – daire içine al.',
    concludeRemove: 'Sonuç zorunlu: {val} kesinlikle dahil DEĞİL – sil.',
    hard: 'Bu konum birden çok bölge arasında daha uzun bir zincir gerektiriyor – vurgulanan bölgeye bak, bir sonraki güvenli hamle orada.',
  },
  achievements: {
    title: 'Başarımlar',
