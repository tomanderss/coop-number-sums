...
export default {
  ...
  team: {
    ...
    weWonByOpponentLives: 'Diğer takım tüm canlarını kaybetti — otomatik olarak kazandınız! ({myPct}% vs. {oppPct}%)',
    weWonByOpponentGaveup: 'Diğer takım teslim oldu — otomatik olarak kazandınız! ({myPct}% vs. {oppPct}%)',
    weLostByLives: 'Takımınız tüm canlarını kaybetti — maç sizin için bitti. ({myPct}% vs. {oppPct}%)',
    weLostByGaveup: 'Takımınız teslim oldu. ({myPct}% vs. {oppPct}%)',
  },
  race: {
    ...
    youWonClean: 'Hatasız olarak önce bitirdin! ({myPct}% vs. {oppPct}%)',
    ...
    youWonByOpponentLives: 'Rakibin tüm canlarını kaybetti — otomatik olarak kazandın! ({myPct}% vs. {oppPct}%)',
    youWonByOpponentGaveup: 'Rakibin teslim oldu — otomatik olarak kazandın! ({myPct}% vs. {oppPct}%)',
    youLostByLives: 'Tüm canlarını kaybettin — yarış senin için bitti. ({myPct}% vs. {oppPct}%)',
    youLostByGaveup: 'Teslim oldun. ({myPct}% vs. {oppPct}%)',
    rematch: 'Tekrar oyna 🔁',
  },
  settings: {
    title: 'Ayarlar',
  ...
  achievements: {
    ...
    raceFirstWin: { title: 'İlk sprint', desc: "Bir 1'e 1 yarış düellosunu kazan." },
    raceTenWins: { title: 'Yarışçı', desc: "10 1'e 1 yarış düellosu kazan." },
