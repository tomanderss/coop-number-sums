...
export default {
  ...
  aiduel: { opponent: 'Rakip', oppPreset: 'Varsayılan', oppClone: 'Klonum', cloneLearning: 'hâlâ öğreniyor ({n}/{need})', title: 'Yapay zekâya karşı düello', hint: 'Kendi tempona göre bir rakip — çevrimdışı da çalışır', opponentName: 'YZ ({level})', strength: 'Güç', start: 'Düelloyu başlat', expected: 'Beklenen rakip süresi: {time}', calibrated: '(ortalama sürelerine göre)', default: '(varsayılan değer)', level: { easy: 'Kolay', medium: 'Orta', hard: 'Zor', brutal: 'Acımasız' } },
