...
export default {
  ...
  shop: {
    catHint: { palette: 'Tahtandaki kafesleri yeniden renklendir — renk ayırt edilebilirliği her zaman korunur.', theme: 'Tüm uygulama için eksiksiz renk dünyaları — OLED siyahından sakuraya.' , sfx: 'Tüm oyun sesleri için yeni ses dünyaları — dinlemek için ▶ dokun.', font: 'Tahtadaki sayılar için yeni yazı stilleri ve efektler.', frame: 'Tahtanın çevresine dekoratif çerçeveler — ahşaptan dönen ışıklı galaksi halkasına.', badge: 'Adının yanında bir rozet — coop\'ta, arkadaş listesinde ve lider tablosunda görünür.'},
