...
export default {
  ...
  saves: { title: 'セーブデータ', openN: 'すべてのセーブ（{n}）', intro: '対局ごとに個別に保存されます。新しく始めても前のデータは残ります。{max}件まで保存できます。', running: '進行中', delete: '削除', deleteTitle: 'セーブを削除しますか？', deleteMsg: 'このセーブは完全に削除されます。', deleted: 'セーブを削除しました', empty: '保存された対局はまだありません。', justNow: 'たった今', minsAgo: '{n}分前', hoursAgo: '{n}時間前', yesterday: '昨日', daysAgo: '{n}日前' },

  aiduel: { opponent: '対戦相手', oppPreset: '標準', oppClone: '自分のクローン', modePreset: '標準AI', modeIndividual: '個人AI', clone: 'クローン', noClones: 'まだ使えるクローンがありません。クローンには解析済みのソロ対局が{need}回必要です（自分もフレンドも同じ）。', learningCount: '{n}体のクローンが学習中', learningTitle: '学習中のクローン', learningIntro: 'これらのクローンはまだ使えません。解析済みのソロ対局が{need}回に達すると対戦できます。', oppCloneName: 'あなたのクローン', oppFriend: 'フレンドのクローン', friendClones: 'フレンドのクローン', clonesLoading: 'クローンを読み込み中 …', cloneLearning: '学習中（{n}/{need}）', title: 'AIとの対戦', hint: 'あなたのペースの相手 — オフラインでも', opponentName: 'AI（{level}）', strength: '強さ', start: '対戦を開始', expected: '相手の想定タイム: {time}', calibrated: '（あなたの平均タイム基準）', default: '（既定値）', level: { easy: 'やさしい', medium: 'ふつう', hard: 'むずかしい', brutal: '極悪' } },
  ...
  soloInvite: {
    button: 'プレイヤーを招待',
    buttonPending: '参加を待っています…',
    title: 'プレイヤーを招待',
    connecting: 'ルームを作成中…',
    msg: 'ゲームはそのまま続行されます。誰かが参加した瞬間から、このボードで一緒にプレイ（協力モード）になります。',
    msgMore: 'このコードを共有すると、進行中のゲームにさらにプレイヤーが参加できます。',
    hint: '友だちは「協力 ▸ 参加」でこのコードを入力します。',
    share: 'コードを共有',
    shareText: '一緒にNumber Sumsで遊ぼう！進行中のゲームに参加してね – ルームコード: {code}',
    copied: 'コードをコピーしました',
    cancel: '招待を取り消す',
    joined: '{name} が参加しました – ここからは一緒にプレイ！',
  },
  pause: {
    title: '一時停止中',
  ...
  coop: {
    ...
    continueSolo: 'ひとりで続ける',
    continueSoloDone: 'ここからはひとりでプレイ – 進行状況は保存されました。',
  ...
  team: {
    ...
    weWon: 'チームの勝利です！',
    weLost: '相手チームが先に完了しました。',
    weWonByOpponentLives: 'チーム{oppTeam}がライフを失いました — 自動的に勝利です！',
    weLostByLives: 'あなたのチーム（チーム{myTeam}）はライフを失いました — マッチは終了しました。',
  },
  chat: {
    typing: '{name}が入力中…',
    title: 'チャット',
  ...
  race: {
    ...
    youWonClean: 'あなたがミスなく最初に完成しました！',
    youWonMistakes: 'あなたが最初に完成しました！',
    youLostClean: '{name}の方が速く、ミスなく完成しました — あなたが遅かったため対戦は終了しました。',
    youLostMistakes: '{name}の方が速く完成しました — あなたが遅かったため対戦は終了しました。',
    youWonByOpponentLives: '{name}がライフを失いました — 自動的に勝利です！',
    youLostByLives: 'あなたはライフを失いました — 対戦は終了しました。',
    rematch: 'もう一度プレイ',
  },
  settings: {
    title: '設定',
  ...
  friends: {
    ...
    mode: { solo: 'ソロ', coop: '協力', race: '1対1', team: 'チーム', endless: 'エンドレス', endlessCoop: '協力エンドレス' },
  ...
  notice: { gift: '{from} さんから「{item}」が贈られました！', revoke: '{from} さんが「{item}」を取り消しました。', currencyPlus: '{from} さんから {n} コインが贈られました！', currencyMinus: '{from} さんが残高を {n} コイン減らしました。', currencySelfPlus: '自分に {n} コインを付与しました。', currencySelfMinus: '残高を {n} コイン減らしました。', giftSelf: '「{item}」を自分に付与しました。', revokeSelf: '「{item}」を自分から削除しました。' },
  shop: {
  ...
  tutor: {
    ...
    next: '次へ',
    apply: 'わかった – 実行',
    lookAt: '{unit}を見てください：ここで丸を付けた数の合計はちょうど {target} でなければなりません。',
    statusKept: 'すでに丸が付いているのは {kept} = {keptSum}。目標まであとちょうど {rem} です。',
    statusNone: 'ここにはまだ丸がありません – あと {rem} が丸ごと必要です。',
    tooLarge: 'ハイライトされた {val} を見てください：それだけで残りの {rem} より大きいのです。丸を付けると合計が超えてしまいます。',
    sumReached: '目標の合計はすでにピッタリ達成されています。これ以上丸を付けると多すぎます – 残りの空きマスは仲間ではありません。',
    allNeeded: '空いている数 {vals} の合計は残りの {rem} とピッタリ同じです。1つでも外すと目標に届きません – 全部必要です。',
    combos: '空いている数（{vals}）のうち、合計がちょうど {rem} になる組み合わせは？数えてみると、これだけです：{combos}。',
    moreCombos: '（他 {n} 通り）',
    inAllCombos: '組み合わせを比べてください：どれにもハイライトされた {val} が含まれています。これなしでは残りの合計に届きません。',
    inNoCombo: '組み合わせを比べてください：ハイライトされた {val} を含むものは1つもありません。仲間ではあり得ません。',
    overlapOther: '同時に{unit2}も見てください：そこではあとちょうど {remB} が足りません。',
    overlapShared: 'これらのマス（{vals}）は両方のエリアに属します。両方の残り合計を突き合わせると、合計は {sums} にしかなりません。',
    concludeKeep: '結論は確定です：{val} は確実に仲間です – 丸を付けましょう。',
    concludeRemove: '結論は確定です：{val} は確実に仲間ではありません – 消しましょう。',
    hard: 'この局面は複数エリアの長い連鎖が必要です – ハイライトされたエリアに次の確実な一手があります。',
  },
  achievements: {
    title: '実績',
