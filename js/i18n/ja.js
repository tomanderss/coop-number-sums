...
export default {
  ...
  aiduel: { opponent: '対戦相手', oppPreset: '標準', oppClone: '自分のクローン', cloneLearning: '学習中（{n}/{need}）', title: 'AIとの対戦', hint: 'あなたのペースの相手 — オフラインでも', opponentName: 'AI（{level}）', strength: '強さ', start: '対戦を開始', expected: '相手の想定タイム: {time}', calibrated: '（あなたの平均タイム基準）', default: '（既定値）', level: { easy: 'やさしい', medium: 'ふつう', hard: 'むずかしい', brutal: '極悪' } },
