...
export default {
  ...
  coop: {
    ...
    startHosting: 'ホストする 🚀',
    yourCode: 'あなたのコード',
    inviteFriends: "友達を招待", invite: "招待", invited: "招待済み", inviteSent: "{name} を招待しました", inviteDeclined: "{name} が辞退しました", inviteAccepted: "{name} が参加しました", inviteTitle: "ロビー招待", inviteBody: "{name} が {mode} ロビーに招待しています。", inviteAccept: "参加", inviteDecline: "辞退", modeCoop: "協力", modeRace: "対戦 (1v1)", modeTeam: "チーム (2v2)",
