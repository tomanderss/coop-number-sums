...
export default {
  ...
  coop: {
    ...
    startHosting: 'ホストする 🚀',
    yourCode: 'あなたのコード',
    inviteFriends: "友達を招待", invite: "招待", invited: "招待済み", inviteSent: "{name} を招待しました", inviteWithdraw: "取り消す", inviteWithdrawn: "{name} への招待を取り消しました", inviteDeclined: "{name} が辞退しました", inviteAccepted: "{name} が参加しました", inviteTitle: "ロビー招待", inviteBody: "{name} が {mode} ロビーに招待しています。", inviteAccept: "参加", inviteDecline: "辞退", modeCoop: "協力", modeRace: "対戦 (1v1)", modeTeam: "チーム (2v2)",
  ...
  team: {
    ...
    winTitleAuto: '勝利！',
    lossTitleAuto: '敗北！',
    opponentLivesLostPerPlayer: '❤️ 相手チームのライフ消費',
  ...
  shop: {
    catHint: { palette: '盤面のケージを塗り替え — 色の見分けやすさは常に保たれます。', theme: 'アプリ全体の配色をまるごと変える — OLEDブラックから桜まで。' , sfx: 'すべての効果音に新しい音色を — ▶ で試聴できます。'},
    free: { palette: 'クラシック', theme: '標準（ライト/ダーク）' , sfx: '標準'},
    it: { zen: '禅の庭', arcade: '8ビットアーケード', kristall: 'クリスタルベル', kosmos: 'コスモス', synthwave: 'シンセウェイブ', kaffee: 'コーヒーハウス', oled: 'OLEDナイト', tiefsee: '深海', wald: '夜の森', sakura: 'さくら', nebula: '星雲', sunset: '夕焼け', cyberpunk: 'サイバーパンク', pastell: 'パステルドリーム', vintage: 'ビンテージ', daemmerung: 'たそがれ', neon: 'ネオングロー', arktis: '北極', spiegel: 'ミラーワールド', cyber: 'サイバーグリッド', karneval: 'カーニバル' },
