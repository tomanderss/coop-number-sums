...
export default {
  ...
  account: {
    ...
    signOutMsg: 'Tes données locales restent sur cet appareil.',
    deleteAccount: '🗑 Supprimer le compte',
    deleteTitle: 'Supprimer le compte définitivement ?',
    deleteMsg: 'Ton compte et toutes les données cloud seront supprimés de façon irréversible. Les données locales de cet appareil sont conservées.',
