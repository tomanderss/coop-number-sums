...
export default {
  ...
  saves: { title: 'Parties sauvegardees', openN: 'Toutes les parties ({n})', intro: 'Chaque partie est sauvegardee separement : lance-en une nouvelle quand tu veux, l ancienne reste. Place pour {max}.', running: 'en cours', delete: 'Supprimer', deleteTitle: 'Supprimer la sauvegarde ?', deleteMsg: 'Cette sauvegarde sera definitivement supprimee.', deleted: 'Sauvegarde supprimee', empty: 'Aucune partie sauvegardee.', justNow: 'a l instant', minsAgo: 'il y a {n} min', hoursAgo: 'il y a {n} h', yesterday: 'hier', daysAgo: 'il y a {n} jours' },

  aiduel: { opponent: 'Adversaire', oppPreset: 'Standard', oppClone: 'Mon clone', modePreset: 'IA standard', modeIndividual: 'IA personnelle', clone: 'Clone', noClones: 'Aucun clone n\'est encore pret. Un clone demande {need} parties solo analysees, les tiennes comme celles de tes amis.', learningCount: '{n} clones apprennent encore', learningTitle: 'Clones en formation', learningIntro: 'Ces clones ne sont pas encore prets. A partir de {need} parties solo analysees, ils peuvent entrer en duel.', oppCloneName: 'Ton clone', oppFriend: 'Clone d\'un ami', friendClones: 'Clones d\'amis', clonesLoading: 'Chargement des clones …', cloneLearning: 'apprend encore ({n}/{need})', title: 'Duel contre l’IA', hint: 'Un adversaire à ton rythme — même hors ligne', opponentName: 'IA ({level})', strength: 'Force', start: 'Lancer le duel', expected: 'Temps attendu de l’adversaire : {time}', calibrated: '(d’après tes temps moyens)', default: '(valeur par défaut)', level: { easy: 'Facile', medium: 'Moyen', hard: 'Difficile', brutal: 'Brutal' } },
  mismatch: { title: 'Données de jeu différentes', sub: 'Votre solde de pièces diffère entre cet appareil et le cloud. Toute la progression (victoires, succès, achats) est fusionnée automatiquement — choisissez seulement quel solde doit s’appliquer.', subGame: 'Cet appareil et le cloud ont chacun une partie inachevée DIFFÉRENTE — vous avez probablement continué à jouer hors ligne. Tout le reste (progression, succès, réglages) est fusionné automatiquement ; choisissez seulement quelle partie en cours doit s’appliquer.', subBoth: 'Votre solde de pièces diffère ET cet appareil et le cloud ont chacun une partie inachevée différente. Toute autre progression est fusionnée automatiquement — choisissez quel côté doit s’appliquer pour le solde et la partie en cours.', local: 'Cet appareil', cloud: 'Cloud', keepLocal: 'Garder cet appareil', keepCloud: 'Garder le cloud', note: 'L’autre état est conservé en sauvegarde et jamais supprimé.' },
  ...
  home: {
    resume: 'Reprendre',
    resumeCoop: 'Reprendre le coop', resumeEndless: 'Reprendre sans fin',
    newGame: 'Mode solo',
  ...
  coop: {
    ...
    yourCode: 'Ton code',
    inviteFriends: "Inviter des amis", invite: "Inviter", invited: "Invité", inviteSent: "{name} invité(e)", inviteWithdraw: "Retirer", inviteJoined: "A rejoint", inviteWithdrawn: "Invitation à {name} retirée", inviteDeclined: "{name} a refusé", inviteAccepted: "{name} a rejoint", inviteTitle: "Invitation au salon", inviteBody: "{name} t'invite dans un salon {mode}.", inviteAccept: "Rejoindre", inviteDecline: "Refuser", modeCoop: "Coop", modeRace: "Duel (1v1)", modeTeam: "Équipe (2v2)", modeFfa: 'Free-for-all',
  ...
  team: {
    ...
    weWon: 'Votre équipe a gagné !',
    weLost: "L'autre équipe a terminé en premier.",
    weWonByOpponentLives: "L'équipe {oppTeam} a perdu toutes ses vies — vous gagnez automatiquement !",
    weLostByLives: "Votre équipe (équipe {myTeam}) a perdu toutes ses vies — le match est terminé pour vous.",
  },
  chat: {
    typing: '{name} écrit …',
    title: 'Chat',
  ...
  race: {
    ...
    youWonClean: "Tu as fini premier, sans erreur !",
    youWonMistakes: "Tu as fini premier !",
    youLostClean: "{name} a été plus rapide et a fini sans erreur — le duel est terminé car tu as été plus lent.",
    youLostMistakes: "{name} a été plus rapide — le duel est terminé car tu as été plus lent.",
    youWonByOpponentLives: "{name} a perdu toutes ses vies — tu gagnes automatiquement !",
    youLostByLives: "Tu as perdu toutes tes vies — le duel est terminé pour toi.",
    rematch: 'Rejouer',
  },
  settings: {
    title: 'Paramètres',
  ...
  admin: {
    ...
    sec: {
      ...
      activeGameEndless: 'Ascension infinie en cours',
  ...
  friends: {
    ...
    mode: { solo: 'Solo', coop: 'Coop', race: '1c1', team: 'Équipe', endless: 'Sans fin', endlessCoop: 'Coop sans fin' },
  ...
  notice: { gift: '{from} t\'a offert « {item} » !', revoke: '{from} t\'a retiré « {item} ».', currencyPlus: '{from} t\'a offert {n} pièces !', currencyMinus: '{from} a réduit ton solde de {n} pièces.', currencySelfPlus: 'Tu t’es crédité {n} pièces.', currencySelfMinus: 'Tu as réduit ton solde de {n} pièces.', giftSelf: 'Tu t’es débloqué « {item} ».', revokeSelf: 'Tu t’es retiré « {item} ».' },
  shop: {
  ...
  tutor: {
    title: 'Tuteur d’indices',
    next: 'Suivant',
    apply: 'Compris – appliquer',
    lookAt: 'Regarde {unit} : les nombres entourés doivent totaliser exactement {target}.',
    statusKept: 'Déjà entourés ici : {kept} = {keptSum}. Il manque donc exactement {rem} pour atteindre la cible.',
    statusNone: 'Rien n’est encore entouré ici – il manque les {rem} au complet.',
    tooLarge: 'Regarde le {val} en surbrillance : à lui seul il est déjà PLUS GRAND que les {rem} manquants. L’entourer rendrait la somme trop élevée.',
    sumReached: 'La somme cible est déjà atteinte EXACTEMENT. Tout nombre supplémentaire serait de trop – aucune cellule ouverte ne peut appartenir.',
    allNeeded: 'Les nombres ouverts {vals} totalisent EXACTEMENT les {rem} manquants. En retirer un seul rend la cible inatteignable – chacun est nécessaire.',
    combos: 'Quels nombres ouverts ({vals}) peuvent totaliser exactement {rem} ? Compte les possibilités – il n’y a que celles-ci : {combos}.',
    moreCombos: '(+{n} autres)',
    inAllCombos: 'Compare les possibilités : CHACUNE contient le {val} en surbrillance. Sans lui, la somme restante est inatteignable.',
    inNoCombo: 'Compare les possibilités : AUCUNE ne contient le {val} en surbrillance. Il ne peut pas appartenir.',
    overlapOther: 'En même temps, {unit2} s’applique : il y manque exactement {remB}.',
    overlapShared: 'Ces cellules ({vals}) sont dans les DEUX zones. En croisant les deux restes, elles ne peuvent totaliser que {sums}.',
    concludeKeep: 'La conclusion est forcée : le {val} appartient à coup sûr – entoure-le.',
    concludeRemove: 'La conclusion est forcée : le {val} n’appartient PAS – efface-le.',
    hard: 'Cette position demande un enchaînement plus long entre plusieurs zones – regarde la zone en surbrillance, le prochain coup sûr s’y trouve.',
  },
  achievements: {
    title: 'Succès',
