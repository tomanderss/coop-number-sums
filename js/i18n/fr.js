...
export default {
  ...
  shop: {
    catHint: { palette: 'Recolore les cages du plateau — les couleurs restent toujours bien distinctes.', theme: 'Des univers de couleurs complets pour toute l\'app — du noir OLED au sakura.' , sfx: 'De nouveaux univers sonores pour tous les sons du jeu — appuie sur ▶ pour écouter.'},
    free: { palette: 'Classique', theme: 'Standard (clair/sombre)' , sfx: 'Standard'},
    it: { zen: 'Jardin zen', arcade: 'Arcade 8 bits', kristall: 'Cloches de cristal', kosmos: 'Cosmos', synthwave: 'Synthwave', kaffee: 'Café viennois', oled: 'Nuit OLED', tiefsee: 'Abysses', wald: 'Forêt nocturne', sakura: 'Sakura', nebula: 'Nébuleuse', sunset: 'Coucher de soleil', cyberpunk: 'Cyberpunk', pastell: 'Rêve pastel', vintage: 'Vintage', daemmerung: 'Crépuscule', neon: 'Lueur néon', arktis: 'Arctique', spiegel: 'Monde miroir', cyber: 'Cyber-grille', karneval: 'Carnaval' },
