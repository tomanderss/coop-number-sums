...
export default {
  ...
  aiduel: { title: 'Duel contre l’IA', hint: 'Un adversaire à ton rythme — même hors ligne', opponentName: 'IA ({level})', strength: 'Force', tempo: 'Rythme', start: 'Lancer le duel', expected: 'Temps attendu de l’adversaire : {time}', calibrated: '(d’après tes temps moyens)', default: '(valeur par défaut)', level: { easy: 'Facile', medium: 'Moyen', hard: 'Difficile', brutal: 'Brutal' } },
