...
export default {
  ...
  aiduel: { title: 'Duel vs AI', hint: 'An opponent at your pace — works offline', opponentName: 'AI ({level})', strength: 'Strength', tempo: 'Pace', start: 'Start duel', expected: 'Expected opponent time: {time}', calibrated: '(based on your average times)', default: '(default value)', level: { easy: 'Easy', medium: 'Medium', hard: 'Hard', brutal: 'Brutal' } },
