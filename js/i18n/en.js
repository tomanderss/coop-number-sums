...
export default {
  ...
  endless: { badge: 'Endless', best: 'Best run: level {n}', cleared: 'Level {n} cleared!', lifeGained: '+1 life', overTitle: 'Run over', reached: 'Reached level {n}', record: 'New record!', levelDone: 'Level {n} cleared!', continue: 'Continue', livesLabel: 'Lives', levelShort: 'Level {n}', levelTime: 'Time for this level', totalTime: 'Total run time' },
