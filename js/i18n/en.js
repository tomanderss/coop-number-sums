...
export default {
  ...
  team: {
    toggleLabel: 'Team vs. team (2 vs 2)',
  ...
  race: {
    ...
    youWon: 'You finished first, mistake-free! ({myPct}% vs. {oppPct}%)',
    youLost: 'Your opponent finished first, mistake-free. ({myPct}% vs. {oppPct}%)',
  },
  settings: {
    title: 'Settings',
