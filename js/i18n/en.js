...
export default {
  ...
  endless: { badge: 'Endless', best: 'Best run: level {n}', cleared: 'Level {n} cleared!', lifeGained: '+1 life', overTitle: 'Run over', reached: 'Reached level {n}', record: 'New record!', levelDone: 'Level {n} cleared!', continue: 'Continue', livesLabel: 'Lives', levelShort: 'Level {n}', levelTime: 'Time for this level', totalTime: 'Total run time', backfillToast: 'Past endless runs credited: {wins} wins from {runs} runs now count in your stats!' },

  saves: { title: 'Saved games', openN: 'All saved games ({n})', intro: 'Every game is saved separately — start a new one whenever you like, the old save stays. Room for {max} saves.', running: 'running', delete: 'Delete', deleteTitle: 'Delete save?', deleteMsg: 'This save will be removed for good.', deleted: 'Save deleted', empty: 'No saved games yet.', justNow: 'just now', minsAgo: '{n} min ago', hoursAgo: '{n} h ago', yesterday: 'yesterday', daysAgo: '{n} days ago' },

  aiduel: { opponent: 'Opponent', oppPreset: 'Preset', oppClone: 'My clone', modePreset: 'Standard AI', modeIndividual: 'Personal AI', clone: 'Clone', noClones: 'No clone is ready yet. A clone takes {need} analysed solo games — yours and your friends alike.', learningCount: '{n} clones still learning', learningTitle: 'Clones in training', learningIntro: 'These clones are not ready yet. After {need} analysed solo games they can enter a duel.', oppCloneName: 'Your clone', oppFriend: 'Friend\'s clone', friendClones: 'Friend clones', clonesLoading: 'Loading clones …', cloneLearning: 'still learning ({n}/{need})', title: 'Duel vs AI', hint: 'An opponent at your pace — works offline', opponentName: 'AI ({level})', strength: 'Strength', start: 'Start duel', expected: 'Expected opponent time: {time}', calibrated: '(based on your average times)', default: '(default value)', level: { easy: 'Easy', medium: 'Medium', hard: 'Hard', brutal: 'Brutal' } },
  mismatch: { title: 'Different game data', sub: 'Your coin balance differs between this device and the cloud. All game progress (wins, achievements, purchases) is merged automatically — just choose which balance should apply.', subGame: 'This device and the cloud each have a DIFFERENT unfinished game — you probably kept playing offline. Everything else (progress, achievements, settings) is merged automatically; just choose which running game should apply.', subBoth: 'Your coin balance differs AND this device and the cloud each have a different unfinished game. All other progress is merged automatically — choose which side should apply for balance and running game.', local: 'This device', cloud: 'Cloud', keepLocal: 'Keep this device', keepCloud: 'Keep cloud', note: 'The other state is kept as a backup and never deleted.' },
  ...
  home: {
    resume: 'Resume',
    resumeCoop: 'Resume Coop', resumeEndless: 'Resume endless',
    newGame: 'Solo mode',
  ...
  setup: {
    ...
    bigNumbersHint: 'Cell values 10–19 instead of 1–9 — same puzzle, new mental twist.',
    random: 'Random',
  ...
  soloInvite: {
    ...
    joined: '{name} joined – you are now playing together!',
  },
  pause: {
    title: 'Paused',
  ...
  coop: {
    ...
    startHosting: 'Host',
    yourCode: 'Your code',
    inviteFriends: "Invite friends", invite: "Invite", invited: "Invited", inviteSent: "{name} invited", inviteWithdraw: "Withdraw", inviteJoined: "Joined", inviteWithdrawn: "Invitation to {name} withdrawn", inviteDeclined: "{name} declined", inviteAccepted: "{name} joined", inviteTitle: "Lobby invite", inviteBody: "{name} invites you to a {mode} lobby.", inviteAccept: "Join", inviteDecline: "Decline", modeCoop: "Co-op", modeRace: "Duel (1v1)", modeTeam: "Team (2v2)", modeFfa: 'Free-for-all',
  ...
  team: {
    ...
    weWon: 'Your team won!',
    weLost: 'The other team finished first.',
    weWonByOpponentLives: 'The other team ran out of lives — you win by default!',
    weLostByLives: 'Your team ran out of lives — the match is over for you.',
  },
  chat: {
  ...
  race: {
    ...
    youWonClean: 'You finished first, mistake-free!',
    youWonMistakes: 'You finished first!',
    youLostClean: '{name} was faster and finished mistake-free — the match is over because you were slower.',
    youLostMistakes: '{name} was faster — the match is over because you were slower.',
    youWonByOpponentLives: '{name} ran out of lives — you win by default!',
    youLostByLives: 'You ran out of lives — the match is over for you.',
    rematch: 'Play again',
  },
  settings: {
    title: 'Settings',
    ...
    desktop: {
      ...
      hint: 'On desktop this key toggles between circle and eraser during a game — without moving the mouse to the tool button. Default: Tab. “Off” disables the shortcut.',
      press: 'Press a key …',
      off: 'Off',
      keySpace: 'Space',
    },
  ...
  notice: { gift: '{from} gifted you "{item}"!', revoke: '{from} removed "{item}" from you.', currencyPlus: '{from} gifted you {n} coins!', currencyMinus: '{from} reduced your balance by {n} coins.', currencySelfPlus: 'You credited yourself {n} coins.', currencySelfMinus: 'You reduced your balance by {n} coins.', giftSelf: 'You unlocked “{item}” for yourself.', revokeSelf: 'You removed “{item}” from yourself.' },
  shop: {
  ...
  prestige: {
    ...
    unlock: {
      kicker: 'Rank unlocked',
      cta: 'Continue',
      more: '+{n} more new tier(s)',
      msg1: 'A first rank is yours — keep going!',
      msg2: 'Silver reached. On the up!',
      msg3: 'Gold! A strong achievement.',
      msg4: 'Legendary! The highest tier of this category.',
    },
  ...
  wallet: {
    ...
    detail: { base: 'base {n}', baseLabel: 'Base', coopFactor: 'Multiplayer', perfect: 'Flawless', bestTime: 'New best time', streak: '+{pct}% streak', streakFactor: 'Streak ({days} days)', total: 'Multiplier' },
  },
  sync: {
  ...
  tutor: {
    ...
    next: 'Next',
    apply: 'Got it – apply',
    lookAt: 'Look at {unit}: the circled numbers here must add up to exactly {target}.',
    statusKept: 'Already circled here: {kept} = {keptSum}. So exactly {rem} is still missing to reach the target.',
    statusNone: 'Nothing is circled here yet – the full {rem} is still missing.',
    tooLarge: 'Now look at the highlighted {val}: on its own it is already BIGGER than the missing {rem}. Circling it would push the sum too high.',
    sumReached: 'The target sum is already reached EXACTLY. Any further circled number would be too much – none of the remaining open cells here can belong.',
    allNeeded: 'The open numbers {vals} add up to EXACTLY the missing {rem}. Leave out even one and the target becomes unreachable – every single one is needed.',
    combos: 'Which of the open numbers ({vals}) can add up to exactly {rem}? Count the options – there are only these: {combos}.',
    moreCombos: '(+{n} more)',
    inAllCombos: 'Compare the options: EVERY single one contains the highlighted {val}. Without it the remaining sum cannot be reached.',
    inNoCombo: 'Compare the options: NOT ONE contains the highlighted {val}. It cannot possibly belong.',
    overlapOther: 'At the same time, {unit2} applies: exactly {remB} is still missing there.',
    overlapShared: 'These cells ({vals}) lie in BOTH areas. Playing both remaining sums against each other, together they can only make {sums}.',
    concludeKeep: 'The conclusion is forced: the {val} definitely belongs – circle it.',
    concludeRemove: 'The conclusion is forced: the {val} definitely does NOT belong – erase it.',
    hard: 'This position needs a longer chain across several areas – look at the highlighted area, the next safe move is in there.',
  },
  achievements: {
    title: 'Achievements',
  ...
  backups: {
    title: 'Safety copies',
    empty: 'No safety copies yet — they are created automatically when a state or saved game is displaced during device sync.',
    conflictLocal: 'Displaced device state',
    conflictCloud: 'Displaced cloud state',
    game: 'Displaced saved game',
    wins: 'wins',
    restore: 'Restore',
    restored: 'Safety copy restored',
    confirmTitle: 'Restore safety copy?',
    confirmDataMsg: 'Your current state will be replaced by the copy and kept as a safety copy itself — nothing is lost.',
    confirmGameMsg: 'The currently saved game will be replaced by the copy and kept as a safety copy itself.',
  },
  whatsnew: {
    badge: 'New',
